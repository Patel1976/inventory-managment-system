...
const AdjustmentList = () => {
  ...
  const [adjustments, setAdjustments] = useState<Adjustment[]>([
    ...
    { id: 5, date: '2024-01-11', reference: 'ADJ-005', store: 'Branch 3', type: 'Addition', products: 4, total: '+80', reason: 'New stock added' },
    { id: 6, date: '2024-01-10', reference: 'ADJ-006', store: 'Main Store', type: 'Subtraction', products: 1, total: '-5', reason: 'Lost item' },
  ]);
