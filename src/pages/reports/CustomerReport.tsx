    ...
    <div className="customer-report-page">
      ...
      <div className="row g-4 mb-4">
        ...
        <div className="col-12 col-md-3">
          <div className="stat-card">
            <div className="stat-content">
              <h3>${totals.sales.toLocaleString('en-US', { minimumFractionDigits: 2 })}</h3>
              <p>Total Sales</p>
            </div>
          </div>
        </div>
              ...
              <tbody>
                {paginatedData.map((customer, index) => (
                  <tr key={index}>
                    ...
                    <td><strong>${customer.totalSales.toFixed(2)}</strong></td>
                    <td style={{ color: '#16a34a' }}>${customer.totalPaid.toFixed(2)}</td>
